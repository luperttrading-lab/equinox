...
Web-App (eine Datei `index.html`, kein Build): Jahreszeiten, Tageslänge und Sonneneinstrahlung.
Sonnenformeln und Landmassen wie in Satellitenhimmel. Version in `APP_VERSION` bei jeder Änderung hochzählen.
